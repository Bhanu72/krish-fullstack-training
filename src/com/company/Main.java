...
// 4 -> NULL
        listObj.head = new LinkedListNode(8);

// 4 -> 6 -> NULL
        listObj.head.next = new LinkedListNode(7);
...
// 4 -> 6 -> 7 -> 1-> 5 -> NULL
        listObj.head.next.next.next.next = new LinkedListNode(4);

// 4 -> 6 -> 7 -> 1-> 5 -> 8 -> NULL
        listObj.head.next.next.next.next.next = new LinkedListNode(3);

// 4 -> 6 -> 7 -> 1-> 5 -> 8 -> 3 -> NULL
        listObj.head.next.next.next.next.next.next = new LinkedListNode(2);

// 4 -> 6 -> 7 -> 1-> 5 -> 8 -> 3 -> 2 -> NULL
        listObj.head.next.next.next.next.next.next.next = new LinkedListNode(1);
